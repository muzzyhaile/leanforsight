...
import { IconBrain, IconGoogle, IconLoader } from '../components/Icons.jsx';
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-10 rounded-2xl shadow-xl border border-slate-100 text-center">
        ...
        <h2 className="text-3xl font-extrabold text-slate-900 mb-3">Welcome to LeanForesight</h2>
        ...
        <p className="mt-8 text-xs text-slate-400">By continuing, you agree to our Terms of Service and Privacy Policy.</p>
      </div>
    </div>
  );
};
